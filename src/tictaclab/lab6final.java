...
public class lab6final {
		...
		private JFrame newframe()
		{
			...
			startlab.setForeground(Color.darkGray);
			startlab.setBackground(Color.darkGray);
			...
			exit0.setBackground(Color.darkGray);
